<template>
	<view class="flexco bigview">
		<view class="bgmask flexco">
			...
			<el-button type="primary" @click="submit" size="large">登录</el-button>
			<!-- <el-button type="primary" @click="goLogin" size="large">真实请求</el-button> -->
		</view>
	</view>
</template>
